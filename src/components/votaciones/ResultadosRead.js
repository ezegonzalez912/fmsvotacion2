        ...
        <div className="resultadosRead__container">
            <div className="resultadosRead__content">
                ...
                </div>
                {
                    formato === "2021" &&
                    <div>
                        <p title="INCREMENTAL">INCRE...</p>
                        <p>{totalData(data.incremental.incremental1)}</p>
                        <p>{totalData(data.incremental.incremental2)}</p>
                    </div>
                }
                <div>
                    <p title="TEMATICAS">TEMAT...</p>
                ...
                </div>
                {
                    ...
                    <div>
                        <p>8x8</p>
                        <p>{totalData(data.clasico8x8.clasico8x81)}</p>
                        <p>{totalData(data.clasico8x8.clasico8x82)}</p>
                    </div>
                }
                <div>
                    <p>DELUXE</p>
