...
export const DefaultMode = ({data, inputChange, competidor, total, handleInputChange, compName}) => {

    return (
        <div className="mode__main">
            {
                competidor ? <input maxLength="10" className="mode__name" type="text" name={competidor} value={compName} onChange={handleInputChange}/> : <p>{compName}</p>
            }
            <div>
