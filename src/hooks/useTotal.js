...
export const useTotal = (data) => {
    ...
    useEffect(() => {
        ...
        + totalData(randomMode.randomMode1) + totalData(firstSangre.firstSangre1) + totalData(secondSangre.secondSangre1) + totalData(deluxeMode.deluxeMode1) + totalData(personajes.personajesMode1))
    ...
    deluxeMode.deluxeMode1, personajes.personajesMode1])
    ...
    useEffect(() => {
        ...
        + totalData(randomMode.randomMode2) + totalData(firstSangre.firstSangre2) + totalData(secondSangre.secondSangre2) + totalData(deluxeMode.deluxeMode2) + totalData(personajes.personajesMode2))
    ...
    deluxeMode.deluxeMode2, personajes.personajesMode2])
