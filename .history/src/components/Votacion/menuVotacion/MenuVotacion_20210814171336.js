                    ...
                    <div className="menu__title">
                        ...
                        <div className="menu__title-icons">
                            <div className="menu__title-question">
                                <p>
                                    -Puntos medios con <span className="color-primary f-w500">.</span> (Punto).<br />
                                    -Con el <span className="color-primary f-w500">+</span> marcas respuesta.<br />
                                    -Con el <span className="color-primary f-w500">TAB</span> avanzas entre inputs.
                                </p>
                            </div>
