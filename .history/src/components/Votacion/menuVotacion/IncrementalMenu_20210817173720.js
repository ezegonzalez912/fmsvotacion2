...
export const IncrementalMenu = ({showTotal}) => {
    ...
    return (
        <div className="menu__vote">
            ...
            <IncrementalMode data={mode.incremental2} inputChange={mode.incrementalInput2} compName={competidor2} total={showTotal ? total2 : "-"}/>
            <IncrementalMode data={mode.incremental1} inputChange={mode.incrementalInput1} compName={competidor1} total={showTotal ? total1 : "-"}/>
        </div>
    )
}