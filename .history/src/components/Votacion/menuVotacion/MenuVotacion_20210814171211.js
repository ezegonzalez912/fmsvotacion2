                    ...
                    <div className="menu__title">
                        ...
                        <div className="menu__title-icons">
                            <div className="menu__title-question">
                                <p>
                                    -Puntos medios con <span className="color-primary">.</span> (Punto).<br />
                                    -Con el <span className="color-primary">+</span> marcas respuesta.<br />
                                    -Con el <span className="color-primary">TAB</span> avanzas entre inputs.
                                </p>
                            </div>
