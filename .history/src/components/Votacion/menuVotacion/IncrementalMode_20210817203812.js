...
export const IncrementalMode = ({data, inputChange, competidor, total}) => {
    ...
    return (
        <div className="mode__main">
            ...
            <div>
                ...
                <input name="input7" value={data.input7} onChange={inputChange} autoComplete="off" className="mode__input" inputMode="tel"/>
                <input name="input8" value={data.input8} onChange={inputChange} autoComplete="off" className="mode__input" inputMode="tel"/>
                <input name="input9" value={data.input9} onChange={inputChange} autoComplete="off" className="mode__input" inputMode="tel"/>
