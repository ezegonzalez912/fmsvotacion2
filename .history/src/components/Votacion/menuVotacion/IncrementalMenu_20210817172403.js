...
export const IncrementalMenu = ({showTotal}) => {
    ...
    const {icnremental: mode} = useContext(DataContext)
    ...
    return (
        <div className="menu__vote">
            ...
            <DefaultMode data={mode.icnremental2} inputChange={mode.incrementalInput2} compName={competidor2} total={showTotal ? total2 : "-"}/>
            <DefaultMode data={mode.icnremental1} inputChange={mode.incrementalInput1} compName={competidor1} total={showTotal ? total1 : "-"}/>
        </div>
    )
}