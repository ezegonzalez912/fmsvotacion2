...
export const DataProvider = ({ children }) => {
    ...
    const [incremental1, incrementalInput1, resetVote20] = useVote();
    const [incremental2, incrementalInput2, resetVote21] = useVote();

    const [clasico8x81, clasico8x8Input1, resetVote22] = useVote();
    const [clasico8x82, clasico8x8Input2, resetVote23] = useVote();
    ...
    const incremental = {incremental1, incremental2, incrementalInput1, incrementalInput2, resetVote20, resetVote21}
    const clasico8x8 = {clasico8x81, clasico8x8Input1, resetVote22, clasico8x82, clasico8x8Input2, resetVote23}
