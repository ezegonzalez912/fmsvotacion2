            ...
            <div className="resultadosRead__content">
                ...
                {formato === "2021" ?
                    ...
                    <>
                        ...
                        <div>
                            <p>Tematicas</p>
                            {totalData(data.firstTematica.firstTematica1) + totalData(secondTematica.secondTematica1)} <br />
                            {totalData(data.firstTematica.firstTematica2) + totalData(secondTematica.secondTematica2)}
                        </div>
                        {
                            formato === "2018" ?
                            <div>
