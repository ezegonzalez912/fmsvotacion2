...
export const MainScreen = ({history}) => {
    ...
    return (
            <div className="screen__main">
                <script type="text/javascript" format="iframe" width="728" height="90" params="" key="19bb3cb280ea14ee0a6ecbe91c9099f0" params="{}">
                    <script type="text/javascript" src="http' + (location.protocol === 'https:' ? 's' : '') + '://www.effectivedisplayformat.com/19bb3cb280ea14ee0a6ecbe91c9099f0/invoke.js"></script>
                </script>
