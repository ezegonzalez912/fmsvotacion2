...
export const useTotal = (data) => {
    ...
    useEffect(() => {
        ...
        + totalData(personajes.personajesMode1) + incremental && + totalData(incremental.incremental1) + totalData(clasico8x8.clasico8x81))
    ...
    deluxeMode.deluxeMode1, personajes.personajesMode1, incremental.incremental1, clasico8x8.clasico8x81])
    ...
    useEffect(() => {
        ...
        + totalData(personajes.personajesMode2) + incremental && totalData(incremental.incremental2) + totalData(clasico8x8.clasico8x82))
    ...
    deluxeMode.deluxeMode2, personajes.personajesMode2, incremental.incremental2, clasico8x8.clasico8x82])
