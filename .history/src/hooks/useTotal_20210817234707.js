...
export const useTotal = (data) => {
    ...
    useEffect(() => {
        ...
        + totalData(personajes.personajesMode1) + totalData(incremental.incremental1) + totalData(clasico8x8.clasico8x81))
    ...
    useEffect(() => {
        ...
        + totalData(personajes.personajesMode2) + totalData(incremental.incremental2) + totalData(clasico8x8.clasico8x82))
