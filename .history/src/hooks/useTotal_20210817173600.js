...
export const useTotal = (data) => {
    ...
    const {easyMode, hardMode, firstTematica, secondTematica, randomMode, firstSangre, secondSangre, deluxeMode, personajes, incremental} = data;
    ...
    useEffect(() => {
        ...
        + totalData(personajes.personajesMode1) + totalData(incremental.incremental1))
    ...
    deluxeMode.deluxeMode1, personajes.personajesMode1, incremental.incremental1])
    ...
    useEffect(() => {
        ...
        + totalData(personajes.personajesMode2) + totalData(incremental.incremental2))
    ...
    deluxeMode.deluxeMode2, personajes.personajesMode2, incremental.incremental2])
